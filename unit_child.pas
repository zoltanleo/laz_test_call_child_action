...
begin
  ...
  begin
    ...
    AppendRecord([AutoID,28,-1,'размеры почки (мм)','','', PtrInt(ctCheckBox), PtrInt(csUncheckedNormal), False, False, PtrInt(ndtTriple)]);
  end;
end;
...
begin
  ...
  begin
    ...
    AppendRecord([AutoID,14,-1,'толщина капсулы (мм)','','', PtrInt(ctCheckBox), PtrInt(csUncheckedNormal), False, False, PtrInt(ndtSingle)]);
